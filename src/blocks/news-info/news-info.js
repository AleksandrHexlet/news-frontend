...
export default class NewsInfo extends BaseComponents {
  ...
  _getUserName() {
    this._container.querySelector(
      ".news-info__user-name"
    ).textContent = this._props.user;
  }
  ...
  _renderKeywords() {
    ...
    const keywordsContainer = this._container.querySelector(
      ".news-info__keywords"
    );
    const keywordContainerOne = keywordsContainer.querySelector(
      ".news-info__keywords_tag_one"
    );
    const keywordContainerTwo = keywordsContainer.querySelector(
      ".news-info__keywords_tag_two"
    );
    const keywordContainerThree = keywordsContainer.querySelector(
      ".news-info__keywords_tag_three"
    );
